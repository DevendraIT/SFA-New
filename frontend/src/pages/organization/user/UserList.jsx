      ...
      <div className="flex items-center justify-between">
        ...
        {!search && !loading && (isCurrentSuperAdmin ? (
            ...
            <button
              onClick={() => {
                if (licenseQuota.isLimitReached) {
                  toast.error("License limit reached. Your organization has consumed all licenses. Contact Franchise Administrator.");
                  return;
                }
              ...
              title={licenseQuota.isLimitReached ? "All licenses consumed. Contact Franchise Administrator." : "Create Company Admin"}
            >
              <Plus size={18} />
          ...
          <button
            ...
            title={licenseQuota.isLimitReached ? "All licenses consumed. Contact Franchise Administrator." : "Create User"}
          >
            <Plus size={18} />
            Create User
          </button>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          {licenseQuota.isLimitReached ? (
            <div className="text-xs font-medium text-red-700 bg-red-100/80 border border-red-200 px-3 py-1.5 rounded-xl flex items-center gap-1.5">
              ...
              <span>All licenses consumed. Contact your Franchise Administrator to upgrade licenses.</span>
            </div>
          ) : (
            <div className="text-xs text-slate-500 font-medium">
              Every created role (Super Admin, Admin, Manager, Sales Executive) counts as 1 license.
            </div>
          )}
        </div>
